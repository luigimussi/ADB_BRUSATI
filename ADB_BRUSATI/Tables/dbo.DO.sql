...
CREATE TABLE [dbo].[DO] (
		...
		[Contabile]                     AS (isnull(CONVERT([bit],case when [Cd_CGCausale] IS NOT NULL then (1) else (0) end,0),(0))),
		[AutoArchivia]                  [bit] NOT NULL,
		[xSetBtnPos]                    [bit] NOT NULL,
		CONSTRAINT [IK_DO]
		UNIQUE
		NONCLUSTERED
		([Id_DO])
...
GO
ALTER TABLE [dbo].[DO]
NOCHECK CONSTRAINT [CK_DO_Provvigione]
GO
ALTER TABLE [dbo].[DO]
	WITH NOCHECK
	ADD
...
GO
ALTER TABLE [dbo].[DO]
NOCHECK CONSTRAINT [CK_DO_Sconto]
GO
ALTER TABLE [dbo].[DO]
	ADD
...
ALTER TABLE [dbo].[DO]
	ADD
	CONSTRAINT [DF_DO_xSetBtnPos]
	DEFAULT ((0)) FOR [xSetBtnPos]
GO
ALTER TABLE [dbo].[DO]
	WITH NOCHECK
